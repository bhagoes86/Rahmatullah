                ...
                @foreach($sarana as $sarana)
                 @foreach($pinjam as $p)
                  ...
                  <td>{{ $sarana->status}}</td>
                   <?php $no++; ?>
                  <td>
                  <a href="/operator/sarana/{{$sarana->id}}" title="Lihat Sarana"><button class="btn btn-success "><i class="fa fa-eye"></i>
                  </button></a>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="/operator/sarana/pinjaman/" method="post">
                        {{ csrf_field() }}
                        
                        <div class="form-group" style="width:100%">
                          <label for="recipient-name" class="control-label">NIS Siswa : <b style="color:red;">*</b></label>
                          <input type="text" class="form-control" name="nis" style="width:100%" pattern="[0-9]{3,15}" maxlength="9" required title="Nis Siswa Harus 9 Karakter Numerik" placeholder="Masukan NIS Siswa">
                        </div>
                        <div class="form-grup">
