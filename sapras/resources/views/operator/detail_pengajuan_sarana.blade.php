      ...
      <div class="box box-default">
          ...
          <div class="box-body">
            <table class="table table-striped">
              ...
              <td>
               <a href="/operator/sarana/pengajuan/{{$sarana->id}}/1"><button class="btn btn-success" onclick="return confirm('Apakah anda yakin ingin mengkonfirmasi pengajuan sarana');"><i class="fa fa-check"></i></button> </a>
                <a href="/operator/sarana/pengajuan/{{$sarana->id}}/3" onclick="return confirm('Apakah anda yakin ingin menolah pengajuan sarana');"><button class="btn btn-danger"><i class="fa fa-close"></i></button></a>
              </td>
              </tr>
              <tr>
              
                <td colspan="3">
                <a href="/operator/sarana/pengajuan/"><button class="btn btn-success">Kembali Ke Halaman Olah Pengajuan</button> </a>
