      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>{{ $total_pengajuan_bp }}</h3>

               <p>Permintaan Pengajuan<br> Belum Diproses<br></p>
            </div>
            <div class="icon">
              <i class="fa fa-briefcase"></i>
            </div>
            <a href="/operator/sarana" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>{{ $total_pinjaman_bp }}</h3>
              <p>Permintaan Pinjaman<br> Belum Diproses<br></p>
            </div>
            <div class="icon">
              <i class="fa fa-building"></i>
            </div>
            <a href="/operator/prasarana" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <p>Pinjaman Sarana<br> Belum Kembali<br>
            </div>
            <div class="icon">
              <i class="fa fa-pie-chart"></i>
            </div>
            <a href="/operator/sarana/pinjaman" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
                ...
                <table align="center" class="table no-margin">
                  ...
                  @foreach($sarana_pinjam as $pinjam)
                   <tr>
                    ...
                    <td>
                      <a href="/operator/sarana/pinjaman/{{$pinjam->id}}/" class="btn btn-success"><i class="fa fa-eye"></i>
                      </a>
                    </td>
                  </tr>
                  @endforeach
                ...
                <table align="center" class="table no-margin">
                  ...
                  @foreach($sarana_pengajuan as $pengajuan)
                   <tr >
                    ...
                    <td>
                      <a href="/operator/sarana/pengajuan/{{$pengajuan->id}}/" class="btn btn-success">
                      <i class="fa fa-eye"></i>
                      </a>
                    </td>
                  </tr>
