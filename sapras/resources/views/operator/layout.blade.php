...
<head>
  ...
  <title>Sistem Informasi Sarana & Prasarana SMKN 1 Cimahi || Halaman Operator</title>
...
<div class="wrapper">
  <header class="main-header">
    <!-- Logo -->
    <a href="/operator/home/" class="logo">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="/operator/profil/{{Auth::user()->username}}" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-left">
