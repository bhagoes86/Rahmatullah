      ...
      <div class="col-md-12">
       ...
       <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
          ...
          <p>Data harus berupa file excel dengan mengikuti format yang sudah ditentukan , format data bisa didownload <b><a href="{{{asset('download/prasarana.zip')}}}" download> disini</a></b></p>
