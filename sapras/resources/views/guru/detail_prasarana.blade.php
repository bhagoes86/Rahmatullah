          ...
          <div class="box-body">
            <table class="table table-striped">
              ...
              <tr>
                ...
                <td colspan="3">
                <a href="/guru/prasarana/"><button class="btn btn-success">Kembali Ke halaman Olah Prasarana</button> </a>
                <a href="/guru/prasarana/{{ $prasarana->id }}/edit"><button class="btn btn-primary">Update Data</button> </a>
              </td>
              </tr>
            </table>
          </div>
