          ...
          <div class="box-body">
            ...
            @foreach($sarana as $sarana)
              ...
              <td>
                ...
                <a href="/guru/sarana/pinjaman/{{$sarana->id}}/1"><button class="btn btn-success"></i>Konfirmasi</button> </a>
                <a href="/guru/sarana/pinjaman/{{$sarana->id}}/2"><button class="btn btn-warning">Tunggu</button></a>
                <a href="/guru/sarana/pinjaman/{{$sarana->id}}/3"><button class="btn btn-danger"></i>Tolak</button></a>
                <a href="/guru/sarana/pinjaman/{{$sarana->id}}/4"><button class="btn btn-primary"></i>Sudak Dikembalikan</button> </a>
              </td>
              </tr>
              <tr>
                
                <td colspan="3">
                <a href="/guru/sarana/pinjaman/"><button class="btn btn-success">Kembali Ke Halaman Olah Pinjaman</button> </a>
                <a href="/guru/sarana/pinjaman/{{ $sarana->id }}/edit"><button class="btn btn-primary">Update Data</button> </a>
              </td>
              </tr>
              @endforeach
            </table>
