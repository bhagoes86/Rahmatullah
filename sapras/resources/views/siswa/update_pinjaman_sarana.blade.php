    ...
    <section class="content">
      ...
      <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <form action="/siswa/sarana/pinjaman/{{ $pinjam->id }}" method="post">
                {{ csrf_field() }}
                {{ method_field('PATCH')}}
                
                    <input type="hidden" class="form-control" value="{{$pinjam->nis}}" name="nis" required pattern="[0-9]{3,15}" maxlength="9" required title="Nis Siswa Harus 9 Karakter Numerik" placeholder="Masukan NIS Siswa">
              ...
              <div class="modal-footer">
                ...
                <a href="/siswa/sarana/pinjaman/{{ $pinjam->id }}/"><button class="btn btn-success">Kembali Ke Halaman Detail</button> </a>
              </div>
